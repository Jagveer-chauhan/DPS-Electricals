...
<html lang="en">
    ...
    <body>
        ...
        <div class="d-flex align-items-center container-fluid p-0 py-5 product-banner justify-content-center">
            <h1 class= "text-light text-center my-3">Distribution Transformer</h1>
        </div>
                ...
                <div class=" d-flex flex-column col-lg-8 p-lg-5 p-md-5 p-sm-5 mt-2 bg-white">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 my-2">
                            <ul>
                                <li class="h6"><i class="fa-solid fa-circle-arrow-right pe-2"></i>Petro-Chemical Industries</li>
                                <li class="h6"><i class="fa-solid fa-circle-arrow-right pe-2"></i>Pharmaceuticals Industries</li>
                                <li class="h6"><i class="fa-solid fa-circle-arrow-right pe-2"></i>Cement Industries</li>
                                <li class="h6"><i class="fa-solid fa-circle-arrow-right pe-2"></i>Hydro Power Projects</li>
                                <li class="h6"><i class="fa-solid fa-circle-arrow-right pe-2"></i>Construction Projects</li>
                                <li class="h6"><i class="fa-solid fa-circle-arrow-right pe-2"></i>Refineries</li>
                            </ul>
                        </div>
                        <div class="col-lg-6 col-md-6 my-2">
                            <ul>
                                <li class="h6"><i class="fa-solid fa-circle-arrow-right pe-2"></i>Hotels</li>
                                <li class="h6"><i class="fa-solid fa-circle-arrow-right pe-2"></i>Hospitals</li>
                                <li class="h6"><i class="fa-solid fa-circle-arrow-right pe-2"></i>Commercial & Residential Towers</li>
                                <li class="h6"><i class="fa-solid fa-circle-arrow-right pe-2"></i>Oil & Gas Plants</li>
                                <li class="h6"><i class="fa-solid fa-circle-arrow-right pe-2"></i>Highway Construction Projects</li>
                                <li class="h6"><i class="fa-solid fa-circle-arrow-right pe-2"></i>High Rise Buildings</li>
                            </ul>
                        </div>
                    </div>
                    <div class="row py-4 px-2">
                        <table class="table table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <td>380 V, 400 V, 415 V, 433 V & 440 V (Any Special Customised Class as per requirement)</td>
                            </tr>
                            <tr>
                                <td>Cooling</td>
                                <td>ONAN</td>
