<nav class="top-header">
    <span>
        <img src="./assets/icons/telephone.png" alt="telephone icon" title="telephone" loading="lazy" height="12" width="12"> <a href="tel:9818520700">&nbsp;(+91) 9818520700</a>
    </span>
    ...
    <div class="menu">
        ...
        <ul class="list">
            ...
            <li><a class="btn btn-floating" href="mailto:Dpselectricals@gmail.com"><i class="fa fa-envelope"></i></a></li>
        </ul>
    </div>
</nav>
